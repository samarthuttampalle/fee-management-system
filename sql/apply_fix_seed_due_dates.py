"""Apply sql/005_fix_seed_due_dates.sql against Azure SQL (local.settings.json)."""
...
SQL_FILE = Path(__file__).resolve().parent / "005_fix_seed_due_dates.sql"
...
def main() -> None:
    ...
    with pyodbc.connect(values["SQL_CONNECTION_STRING"], autocommit=True, timeout=60) as conn:
        ...
        for batch in batches:
            ...
            while cur.nextset():
                pass
    print("Applied 005_fix_seed_due_dates.sql")
